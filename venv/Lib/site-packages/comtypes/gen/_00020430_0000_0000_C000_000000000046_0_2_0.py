...
__all__ = [ 'IPictureDisp', 'Picture', 'Monochrome',
           'OLE_XPOS_PIXELS', 'Gray', 'FONTSTRIKETHROUGH',
           'OLE_YPOS_CONTAINER', 'IFontDisp', 'FONTBOLD', 'StdFont',
           'FONTNAME', 'OLE_OPTEXCLUSIVE', 'OLE_XPOS_CONTAINER',
           'IFontEventsDisp', 'OLE_YPOS_HIMETRIC',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_YPOS_PIXELS',
           'OLE_YSIZE_PIXELS', 'FONTITALIC', 'IPicture', 'OLE_COLOR',
           'Default', 'FONTSIZE', 'FontEvents', 'IFont',
           'OLE_XSIZE_PIXELS', 'Color', 'LoadPictureConstants',
           'FONTUNDERSCORE', 'OLE_XSIZE_HIMETRIC',
           'OLE_YSIZE_HIMETRIC', 'OLE_XSIZE_CONTAINER',
           'OLE_XPOS_HIMETRIC', 'VgaColor', 'OLE_TRISTATE',
           'StdPicture', 'OLE_CANCELBOOL', 'Font', 'Checked',
           'OLE_HANDLE', 'Unchecked', 'OLE_YSIZE_CONTAINER']
